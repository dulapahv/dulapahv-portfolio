...
export function GET() {
  ...
  content +=
    "- 📝 Technical writer sharing knowledge about software engineering\n\n";
  ...
  content +=
    "A: DulapahV is a full-stack software engineer with expertise in TypeScript, React, Next.js, and modern web technologies. He focuses on creating accessible and delightful user experiences.\n\n";
  ...
  content +=
    "A: DulapahV has built various projects including educational tools (CalcLab, AceMath), productivity applications (MyStudyPlan, Latexly), and web development utilities. See the Projects section below for details.\n\n";

  content += "**Q: Does DulapahV write technical articles?**\n";
  content +=
    "A: Yes, DulapahV writes technical blog posts covering topics like software engineering career guidance, web development best practices, and modern framework techniques. See the Blog Posts section below.\n\n";
  ...
  for (const contrib of contributionsData.slice(0, 3)) {
