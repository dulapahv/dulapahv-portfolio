...
export function GET() {
  ...
  const mergedContributions = contributionsData
  ...
  content +=
    "- **Accessibility First:** Committed to building technology that everyone can use\n";
  content +=
    "- **User-Centric Design:** Focus on creating delightful user experiences\n";
  content +=
    "- **Open Source:** Active contributor to the open source community\n";
  content +=
    "- **Continuous Learning:** Passionate about staying current with modern technologies\n";
  content +=
    "- **Knowledge Sharing:** Dedicated to helping others through technical writing\n\n";
  ...
  content +=
    "- **Blog Posts:** Technical articles covering software engineering, web development, and best practices\n";
  content +=
    "- **Projects:** Open source and personal projects demonstrating technical skills\n";
  content +=
    "- **Work Experience:** Professional experience in software engineering roles\n\n";

  content +=
    "For detailed information about specific projects, blog posts, or work experience, see:\n";
  ...
  content +=
    "DulapahV primarily works with TypeScript, React, Next.js, and modern web technologies. He has expertise in full-stack development, focusing on user experience and accessibility.\n\n";
