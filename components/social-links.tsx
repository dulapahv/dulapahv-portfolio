  ...
  return (
    <div className="flex gap-2">
      ...
      >
        <div
          className={cn(
            `from-mirai-yellow to-mirai-yellow/60 rounded-md bg-linear-to-br p-1 text-white shadow-md
      ...
      >
        <div
          className={cn(
            `flex items-center justify-center rounded-md bg-linear-to-br from-blue-600 to-blue-400 p-1 text-white
      ...
      >
        <div
          className={cn(
            `flex items-center justify-center rounded-md bg-linear-to-br from-gray-600 to-gray-400 p-1 text-white
            shadow-md transition-transform`
          )}
        >
