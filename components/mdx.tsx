    ...
    return (
      <HeadingTag id={id} {...props} className="group relative">
        {id && (
          ...
          >
            <LuLink className="size-4 flex-shrink-0" />
          </Link>
        )}
        {children}
      </HeadingTag>
  ...
  <>
    ...
    <article
      className={cn(
        ...
        prose-blockquote:[&>p]:after:content-none prose-blockquote:text-foreground-muted
        prose-blockquote:rounded-l-sm`,
