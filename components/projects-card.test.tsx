...
describe('ProjectsCard', () => {
  ...
  it('should navigate to specific project when dot indicator is clicked', () => {
    ...
    const dotIndicators = screen.getAllByRole('button', { name: /go to project/i });
  ...
  it('should have links to individual projects', () => {
    ...
    const links = screen.getAllByRole('link', { name: /test project/i });
    expect(links.length).toBeGreaterThan(0);
    expect(links[0]).toHaveAttribute('href', expect.stringContaining('/project/'));
  });
