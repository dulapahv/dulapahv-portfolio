const Floaties = () => {
  return (
    <div className="relative w-screen *:absolute *:rounded-full *:opacity-70">
      <div className="left-[8%] top-[256px] size-4 animate-shake-vertical bg-RED" />
      <div className="left-[13%] top-[176px] size-8 animate-shake-vertical bg-BLUE animation-delay-400" />
      <div className="left-[36%] top-[128px] size-16 animate-shake-vertical bg-YELLOW animation-delay-800" />
      <div className="left-[68%] top-[128px] size-12 animate-shake-vertical bg-PURPLE animation-delay-1200" />
