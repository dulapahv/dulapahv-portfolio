...
export const DESCRIPTION = `Hello, I'm ${NAME}, a Thai Software Engineer based in Glasgow, Scotland. I'm passionate about making technology accessible to everyone. I'm currently a Software Engineer at NatWest Group a British banking and insurance holding company.`;
