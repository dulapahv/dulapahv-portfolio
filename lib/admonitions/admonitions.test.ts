...
describe("notificationTypes", () => {
  ...
  it("should have IMPORTANT type", () => {
    const important = notificationTypes.find(
      (type) => type.keyword === "IMPORTANT"
    );
  ...
  it("should have WARNING type", () => {
    const warning = notificationTypes.find(
      (type) => type.keyword === "WARNING"
    );
  ...
  it("should have CAUTION type", () => {
    const caution = notificationTypes.find(
      (type) => type.keyword === "CAUTION"
    );
