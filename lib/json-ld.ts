...
export const personSchema: WithContext<Person> = {
  ...
  award: [
    ...
    "Double Degree Programme Graduate",
  ],
...
export const collectionSchema = (
  ...
  mainEntity: {
    "@type": "ItemList",
    numberOfItems: getCollection(type as ContentType).length,
    itemListElement: getCollection(type as ContentType).map((item, index) => ({
      "@type": "ListItem",
      position: index + 1,
