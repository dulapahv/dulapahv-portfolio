...
export const EDUCATION_LOCATION: COBEOptions["markers"] = [
  // KMITL, Thailand
  { location: [13.729_888_9, 100.775_652], size: 0.1 },
  // UofG, United Kingdom
  { location: [55.871_694_6, -4.291_365_5], size: 0.1 },
];
...
export const WORK_LOCATION: COBEOptions["markers"] = [
  ...
  { location: [13.864_167, 100.5725], size: 0.1 },
];
...
export const TRAVEL_LOCATIONS: COBEOptions["markers"] = [
  ...
  // Chiang Mai, Thailand
  { location: [18.706_064, 98.981_716], size: 0.1 },
  // Phuket, Thailand
